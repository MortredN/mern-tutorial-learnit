  ...
  return (
    <Navbar expand='lg' bg='primary' variant='dark' className='shadow px-3'>
      <Navbar.Brand className='fw-bolder text-white'>
        <img src={logo} alt='learnItLogo' width='32' height='32' className='me-2' />
        LearnIt
      </Navbar.Brand>
      <Navbar.Toggle aria-controls='basic-navbar-nav' />
      <Navbar.Collapse>
        <Nav className="me-auto">
          <Nav.Link className='fw-bolder text-white' to='/dashboard' as={Link}>Dashboard</Nav.Link>
          <Nav.Link className='fw-bolder text-white' to='/about' as={Link}>About</Nav.Link>
        </Nav>
        <Nav>
          <Nav.Link className='fw-bolder text-white' disabled>Welcome {username}</Nav.Link>
